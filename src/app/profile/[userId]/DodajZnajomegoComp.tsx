  ...
  return (
    <div className="space-y-3 m-6">
      ...
      <div className="h-[2px] bg-black w-full mt-0" 
            aria-hidden="true"/>
      <Button
        className=" mt-5 w-full py-[17px] rounded-full cursor-pointer border-0 bg-black uppercase text-[15px] transition-all duration-500 ease-in-out hover:tracking-[1px] hover:text-white active:tracking-[3px] active:bg-white active:text-black active:translate-y-[-2px] active:duration-[100ms]"
        onClick={async () => {
